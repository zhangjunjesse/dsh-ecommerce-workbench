 ...
 *
 * Deliberately **empty**. The engine — registry, scheduler, run history, log
 * view — is independent of any particular workflow, and this array is the one
 * line a new workflow is added to. Shipping it empty is the honest state of the
 * module: infrastructure that runs nothing yet, rather than a placeholder that
 * pretends to do work.
 *
 ...
 * history — no client change needed.
 */
