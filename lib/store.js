 ...
 *   state.json        metadata: { library, recreations, tshirts, tshirtRecreations, prompts, generations, scenes }
...
const EMPTY_STATE = { library: [], recreations: [], tshirts: [], tshirtRecreations: [], prompts: [], generations: [], scenes: [] };
