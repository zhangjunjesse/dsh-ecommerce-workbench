  ...
  factory: function (require) {
    ...
    function apply(ctx) {
      ...
      function ProductLibrary(props) {
        ...
        var feed = h("div", { ref: poolRef, style: { flex: 1, minHeight: 0, overflow: "auto", padding: "2px 4px 16px" } },
          h("div", null,
      ...
      function useColumnCount(ref) {
        ...
        React.useEffect(function () {
          ...
          function measure() {
            ...
            var next = Math.max(1, Math.floor((width + MASONRY_COL_GAP) / (MASONRY_COL_MIN + MASONRY_COL_GAP)));
