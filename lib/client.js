...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function apply(ctx) {
      ...
      /**
       * The narrowest column in the 成品库 feed.
       *
       * Much smaller than the scene pool's 220: this is a shelf to scan, the pane
       * it lives in is not wide, and the point is how many shots fit on one
       * screen rather than how large each is. Smaller tiles are also why the
       * caption under each one is a single short line.
       */
      var PRODUCT_COL_MIN = 120;
