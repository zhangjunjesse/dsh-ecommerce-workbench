      ...
      function ProductModal(props) {
        ...
        return h("div", {
          ...
          h("div", {
            ...
            // 款式 switcher: one row, its own horizontal scroll.
            h("div", { style: { flex: "0 0 auto", marginTop: 12 } },
              ...
              h("div", { style: { display: "flex", gap: 8, overflowX: "auto", paddingBottom: 4 } },
                styles.map(function (style, index) {
                  ...
                  return h("button", {
                    ...
                    style: { flex: "0 0 auto", width: 62, padding: 0, borderRadius: 10, overflow: "hidden", cursor: "pointer", background: "#f5f5f7", border: "2px solid " + (active ? "#1c1d1f" : "#ececf0") }
                  },
                    h("img", { src: fileUrl(style.file), loading: "lazy", alt: "", style: { width: "100%", aspectRatio: "3 / 4", objectFit: "cover", display: "block" } }),
                    h("span", { style: { display: "block", padding: "3px 0", fontSize: 10.5, color: active ? UI.text : UI.text2, fontWeight: active ? 600 : 400, textAlign: "center" } }, "#" + (index + 1)));
                })))));
      }
