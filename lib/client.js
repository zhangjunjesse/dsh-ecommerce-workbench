  ...
  factory: function (require) {
    ...
    function apply(ctx) {
      ...
      function ProductViewer(props) {
        ...
        /**
         * The page fills the pane and nothing inside it may grow past that.
         *
         * The first version let the cover keep `width: 100%; height: 100%` inside
         * an indefinite-height flex row, so the height resolved to the image's
         * intrinsic one and the whole page grew to the picture's size — the image
         * simply did not fit on screen. A definite height down the chain (the page
         * is a column that fills, the row takes what is left, the stage takes what
         * the row leaves) plus `max-width/max-height: 100%` on the image is what
         * makes it scale down instead.
         */
        var arrow = function (side) {
          return {
        ...
        return h("div", { style: { flex: 1, minHeight: 0, overflow: "hidden", display: "flex", flexDirection: "column", padding: "2px 4px 12px" } },
              ...
              h("div", { style: { flex: 1, minHeight: 0, position: "relative", borderRadius: 14, background: "#f5f5f7", border: "1px solid #ececf0", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" } },
                shot
                  ? h("img", {
                      ...
                      // Never larger than the stage, and never stretched: contain
                      // shows the whole shot, which is what "详情" is for.
